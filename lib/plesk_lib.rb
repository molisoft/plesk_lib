...
require 'plesk_lib/actions/change_customer_login'
require 'plesk_lib/actions/change_customer_status'
require 'plesk_lib/actions/change_customer_subscription_plan'
require 'plesk_lib/actions/change_customer_subscription'
